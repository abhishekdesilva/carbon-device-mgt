...
public class GenericOperationDAOImpl implements OperationDAO {
    ...
    @Override
    public String hasExistingOperations(int enrolmentId, String operationCode)
            throws OperationManagementDAOException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String result = "";
        try {
            ...
            rs = stmt.executeQuery();
            if (rs.next()) {
                result = rs.getString("OPERATION_ID");
            }
        } catch (SQLException e) {
            throw new OperationManagementDAOException("Error occurred while update device mapping operation status " +
                                                      "metadata", e);
    ...
    @Override
    public List<Activity> getActivityList(List<java.lang.Integer> activityIds) throws OperationManagementDAOException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
